...
namespace webby {
  ...
  class request_error : public std::runtime_error {
    public:
      /**
       * @brief Constructs the `webby::request_error` object.
       * @param[in] what_arg Explanatory string.
       */
      explicit request_error(const std::string& what_arg) : runtime_error(what_arg) { }

      /**
       * @brief Constructs the `webby::request_error` object.
       * @param[in] what_arg Explanatory string.
       */
      explicit request_error(const char* what_arg) : runtime_error(what_arg) { }
  };
  ...
  class request {
    ...
    protected:
       ...
       * @throws webby::request_error if the request line was not valid.
       *
