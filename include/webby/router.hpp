...
namespace webby {
  /**
   * @brief Reports errors generated by webby::router and its subclasses.
   */
  class router_error : public std::runtime_error {
    public:
      /**
       * @brief Constructs the `webby::router_error` object.
       * @param[in] what_arg Explanatory string.
       */
      explicit router_error(const std::string& what_arg) : runtime_error(what_arg) { }

      /**
       * @brief Constructs the `webby::router_error` object.
       * @param[in] what_arg Explanatory string.
       */
      explicit router_error(const char* what_arg) : runtime_error(what_arg) { }
  };
